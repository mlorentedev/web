...
supersededBy:
  ...
  summary: "The Ansible automation patterns here targeted a federated multi-node K3s cluster across VMs. The architecture has since shifted to independent single-node K3s clusters per environment, managed through declarative GitOps pipelines with Argo CD."
---
