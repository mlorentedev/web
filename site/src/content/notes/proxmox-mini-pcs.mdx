...
supersededBy:
  ...
  summary: "Proxmox was later removed from the fleet. Running a hypervisor consumed unnecessary RAM on 12GB mini PCs without providing meaningful isolation for single-purpose nodes. All nodes now run direct bare-metal OS installs with systemd or K3s."
---
