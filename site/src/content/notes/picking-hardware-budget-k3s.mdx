...
supersededBy:
  ...
  summary: "This article details the initial hardware acquisition plan from late 2024. The operational fleet has since expanded to 8 machines across on-prem and cloud, balancing ARM and x86 nodes with dedicated edge inference."
---
